...
def create_dataset(start_year, end_year, dataset, num):
    parameters = {
    ...
    epitope_d = [96, 102, 103, 117, 121, 167, 170, 171, 172, 173, 174, 175, 176, 177, 179, 182, 201, 203, 207, 208, 209,
    ...
    if parameters['clustering_method'] != 'random':
        ...
        test_strains_by_year, test_clusters_by_year = utils.cluster_years(test_strains_by_year, parameters['data_path'],
                                                                          parameters['clustering_method'])
        ...
        test_strains_by_year = cluster.sample_from_clusters(test_strains_by_year, test_clusters_by_year,
                                                            parameters['testing_samples'], verbose=True)
